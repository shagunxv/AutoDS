...
def train_models(X_train, X_test, y_train, y_test, problem_type):
    ...
    if problem_type == "Classification":
        ...
        models = {
            ...
            "Random Forest": RandomForestRegressor(random_state=42, max_depth=10, n_estimators=20, n_jobs=1),
            "Ridge Regression": Ridge(),
            "Lasso Regression": Lasso(),
            "KNN Regressor": KNeighborsRegressor(n_neighbors=5),
            "Gradient Boosting": GradientBoostingRegressor(random_state=42, n_estimators=50),
            "Extra Trees": ExtraTreesRegressor(random_state=42, n_estimators=20, max_depth=10, n_jobs=1)
        }
    ...
    joblib.dump(models[best_model], "saved_models/best_model.pkl")
